...
(function () {
    // Si ya se inicializó en otra carga, detenemos la ejecución para evitar el SyntaxError
    if (window.luckyDropInitialized) return;
    window.luckyDropInitialized = true;
